...
const StepsSection = () => {
  const steps = [
    ...
    },
    {
      ...
      description: "Подготовим полный пакет документов по банкротству для подачи заявления в арбитражный суд. Соберем за вас все необходимые справки.",
      duration: "1-2 недели",
      details: [
    ...
    },
    {
      ...
      details: [
        ...
        "Подача в суд",
        "Полное сопровождение банкротства под ключ"
      ]
    },
    {
      number: "04",
    ...
    },
    {
      ...
      details: [
        "Полное взаимодействие с управляющим",
        "Защита имущества",
        "Направление всех необходимых ходатайств по делу"
      ]
    },
    {
      number: "06",
