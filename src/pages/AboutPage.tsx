...
const AboutPage = () => {
  const [pageData, setPageData] = useState({ heading: "Юридическая компания ВЕРНОЕ РЕШЕНИЕ", description: "" });
  ...
  const advantages = [
    { icon: "Shield", title: "Надежность", description: "5 лет успешной работы и более 7 тысяч довольных клиентов" },
    { icon: "Award", title: "Профессионализм", description: "Команда опытных юристов с высшим образованием" },
    { icon: "Users", title: "Индивидуальный подход", description: "Персональное решение для каждого клиента" },
    { icon: "Clock", title: "Оперативность", description: "Быстрое реагирование и решение вопросов" },
    { icon: "TrendingUp", title: "Высокий результат", description: "100% выигранных дел в судах" },
    { icon: "FileCheck", title: "Прозрачность", description: "Честные цены без скрытых платежей" },
  ];
      ...
      <main className="pt-24">
        <div className="container mx-auto px-4 py-12">
          <div className="text-center mb-16">
            ...
            <h1 className="text-5xl font-bold text-foreground mb-6">{pageData.heading}</h1>
                  ...
                  >
                    <div className="h-64 overflow-hidden">
                      <img
                        src={member.photo}
                        alt={member.name}
                        className={`w-full h-full object-cover ${member.photo_position || "object-top"}`}
                      />
                    </div>
                    <div className="p-6">
